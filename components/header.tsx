      ...
      <AnimatePresence>
        ...
        >
          <motion.button onClick={() => {
            ...
            <XIcon className="size-6 absolute top-8 right-6" strokeWidth={1.5} />
          </motion.button>

          <div className="p-6 py-32 grid gap-2">
            <div className="overflow-y-hidden">
              <Link href="/">
                <motion.p initial={{ y: 80 }} animate={{ y: 0 }} className="text-4xl tracking-tighter font-medium"
            ...
            <div className="overflow-y-hidden">
              <Link href="/resume">
                <motion.p initial={{ y: 80 }} animate={{ y: 0 }} className="text-4xl tracking-tighter font-medium"
                  transition={{ type: "spring", delay: 0.10, damping: 20, stiffness: 150 }}
                >
                  Resume
                </motion.p>
              </Link>
            ...
            <motion.div
              ...
              transition={{ type: "spring", delay: 0.20, damping: 20, stiffness: 150 }}
              className="w-fit"
            >
              <Button className="bg-primary w-fit my-12 rounded-full text-base font-normal tracking-tighter font-mono hover:text-primary hover:bg-background border border-primary" size="lg" asChild>
                <Link href="mailto:aaronvendedor@gmail.com">
                  Contactame
                </Link>
              </Button>
